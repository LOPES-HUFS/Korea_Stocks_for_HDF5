...
전체 주식 종목 파일의 경우에는 다음과 같이 원하는 주식 종목코드로 접근해서 사용할 수 있습니다. 아래의 코드에서는 전체 주식 종목 중 삼성전자의 데이터에 접근하는 것을 예시로 보여죽 있습니다. 직접 사용하실 경우 `data.frame(all_sample$kor_005930)` 코드의 "kor_005930" 부분을 "kor_원하는 주식 종목의 코드" 로 변경해주셔서 사용하시면 됩니다. 
